...
//0 titulo de la categoria, 1 enlace a ver la categoria
let categoriaIPL =  '<div class="categoria">'+
                        ...
                        '<div class="subcategoria d-flex flex-row justify-content-between">'+ 
                        '</div>'+
                    '</div>'
...
let subcategoriaIPL =   '<div class="d-flex flex-column">'+ 
